...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--num_blocks', type=int, default=9, help='in case of resnet_varblocks sets number of blocks')
        self.parser.add_argument('--num_blocks_of_g1', type=int, default=9,
                                 help='in case of resnet_varblocks sets number of blocks')
        ...
        self.parser.add_argument('--images_dir', type=str, default='./images', help='models are saved here')
        ...
        self.parser.add_argument('--port', type=int, default=8097, help='port for visdom')

        self.parser.add_argument('--no_lsgan', action='store_true', help='do *not* use least square GAN, if false, use vanilla GAN')
        self.parser.add_argument('--no_sigmoid', action='store_true')
        self.parser.add_argument('--correlation_criterion', type=str, default='l1', help='l1 or l2 correlation')
        self.parser.add_argument('--save_dir_for_g1', type=str, default='/media/data2/sagieb/DistanceGAN_risk/checkpoints/maps_results/maps_cyclerisk_9_blocks/')
